...
def main():
    parser = argparse.ArgumentParser(description="Single-turn JSON extractor with vLLM")
    parser.add_argument("--model", type=str, default="/home/zheng/models/Qwen2.5-7B-Instruct")
    parser.add_argument("--tp", type=int, default=1)
    parser.add_argument("--visible_devices", type=str, default="")
    parser.add_argument("--temperature", type=float, default=0.2)
    parser.add_argument("--top_p", type=float, default=0.95)
...
"""
[
    {"feature": "food quality", "opinion": "clam chowder which was excellent", "sentiment_score": 1},
    {"feature": "food quality", "opinion": "muscles which were the best I've ever had", "sentiment_score": 1},
    {"feature": "overall experience", "opinion": "I would recommend eating at this restaurant", "sentiment_score": 1},
    {"feature": "ambiance", "opinion": "There is also an excellent view", "sentiment_score": 1}
]
"""
